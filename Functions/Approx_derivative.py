"""
To approximate the derivate from a given time series, we make use of a code from the repository 
https://github.com/Willcox-Research-Group/rom-operator-inference-Python3. We would like to thank them for it.
It is under the MIT Licence; see https://github.com/Willcox-Research-Group/rom-operator-inference-Python3/blob/main/LICENSE
"""
